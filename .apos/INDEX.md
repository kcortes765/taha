...
Ultima actualizacion: 2026-05-01 10:57

## Lectura minima para `/apos-status`
1. `CONTEXT_POLICY.md`
2. `STATUS.md`
3. `HANDOFF.md`
4. `PLAN.md`
...
- - apos-status: enabled
- - guardar: enabled
- - safe-harness / apos-run: enabled
- - chat-transfer: internal
- - research-autonomo: internal
- - quality-evals: internal
- - mcp-readonly: disabled
